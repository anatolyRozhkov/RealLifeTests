...
def test_make_requests_to_banners_as_user(http_method, user_api_client):
    """Test make post and get requests to banners as a user."""
...
def test_make_requests_to_banners_by_id_a_user(http_method, user_api_client):
    """Test make get, put, patch, delete requests to banners by id as a user."""
